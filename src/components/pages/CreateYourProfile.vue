        ...
        <div class="create-your-profile__form__preview">
          ...
          <template v-else>
            <div class="profile-video__container">
              ...
              <video class="profile-video__video" tabindex="0" autobuffer="autobuffer" preload="preload" autoplay muted loop playsinline>
                <source type="video/mp4; codecs=&quot;avc1.42E01E, mp4a.40.2&quot;" src="/videos/profile/tins.mp4" />
